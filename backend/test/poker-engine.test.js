...
describe('Poker Engine - Hand Evaluation', () => {
  ...
  test('evaluates Straight Flush', () => {
    const holeCards = [createCard('9', 'spades'), createCard('8', 'spades')]
    const communityCards = [
      createCard('7', 'spades'),
      createCard('6', 'spades'),
      createCard('5', 'spades'),
  ...
  test('evaluates Four of a Kind', () => {
    const holeCards = [createCard('K', 'hearts'), createCard('K', 'diamonds')]
    const communityCards = [
      createCard('K', 'clubs'),
      createCard('K', 'spades'),
      createCard('A', 'hearts'),
  ...
  test('evaluates Full House', () => {
    const holeCards = [createCard('Q', 'hearts'), createCard('Q', 'diamonds')]
    const communityCards = [
      createCard('Q', 'clubs'),
      createCard('8', 'spades'),
      createCard('8', 'hearts'),
  ...
  test('evaluates Flush', () => {
    const holeCards = [createCard('A', 'diamonds'), createCard('10', 'diamonds')]
    const communityCards = [
  ...
  test('evaluates Straight', () => {
    const holeCards = [createCard('9', 'hearts'), createCard('8', 'diamonds')]
    const communityCards = [
      createCard('7', 'clubs'),
      createCard('6', 'spades'),
      createCard('5', 'hearts'),
  ...
  test('evaluates Wheel (A-2-3-4-5 straight)', () => {
    const holeCards = [createCard('A', 'hearts'), createCard('2', 'diamonds')]
    const communityCards = [
      createCard('3', 'clubs'),
      createCard('4', 'spades'),
      createCard('5', 'hearts'),
  ...
  test('evaluates Three of a Kind', () => {
    const holeCards = [createCard('J', 'hearts'), createCard('J', 'diamonds')]
    const communityCards = [
      createCard('J', 'clubs'),
      createCard('A', 'spades'),
      createCard('K', 'hearts'),
  ...
  test('evaluates Two Pair', () => {
    const holeCards = [createCard('10', 'hearts'), createCard('10', 'diamonds')]
    const communityCards = [
      createCard('5', 'clubs'),
      createCard('5', 'spades'),
      createCard('A', 'hearts'),
  ...
  test('evaluates One Pair', () => {
    const holeCards = [createCard('9', 'hearts'), createCard('9', 'diamonds')]
    const communityCards = [
      createCard('A', 'clubs'),
      createCard('K', 'spades'),
      createCard('Q', 'hearts'),
  ...
  test('evaluates High Card', () => {
    const holeCards = [createCard('A', 'hearts'), createCard('K', 'diamonds')]
    const communityCards = [
      createCard('Q', 'clubs'),
      createCard('J', 'spades'),
      createCard('9', 'hearts'),
...
describe('Poker Engine - Edge Cases', () => {
  test('handles fewer than 5 cards', () => {
    const holeCards = [createCard('A', 'hearts'), createCard('K', 'hearts')]
    const communityCards = [createCard('Q', 'hearts')]
  ...
  test('handles more than 5 community cards', () => {
    const holeCards = [createCard('A', 'hearts'), createCard('A', 'diamonds')]
    const communityCards = [
      createCard('A', 'clubs'),
      createCard('K', 'spades'),
      createCard('K', 'hearts'),
  ...
  test('selects best 5-card hand from 7 cards', () => {
    const holeCards = [createCard('7', 'hearts'), createCard('2', 'clubs')]
    const communityCards = [
